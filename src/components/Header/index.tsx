...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-88 flex w-full bg-whiten">
      <div className="flex flex-grow items-center justify-between px-4 py-2 md:px-4 2xl:px-4">
        ...
        <div className="hidden md:block">{/*<NotificationBanner />*/}</div>
